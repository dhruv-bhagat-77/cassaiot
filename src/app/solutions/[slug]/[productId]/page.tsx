...
// Mock product data
const getProductById = async (slug: string, productId: string) => {
  const products = {
    'vision': {
      'cass-vision-flow': {
        id: 'cass-vision-flow',
  ...
  return products[slug as keyof typeof products]?.[productId as keyof typeof products[typeof slug]] || null;
};
